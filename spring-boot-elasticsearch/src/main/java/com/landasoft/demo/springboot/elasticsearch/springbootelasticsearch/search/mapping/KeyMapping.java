package com.landasoft.demo.springboot.elasticsearch.springbootelasticsearch.search.mapping;

import com.landasoft.demo.springboot.elasticsearch.springbootelasticsearch.SpringBootElasticsearchApplication;
import com.landasoft.demo.springboot.elasticsearch.springbootelasticsearch.model.FieldDefinition;
import com.landasoft.demo.springboot.elasticsearch.springbootelasticsearch.model.Key;
import com.landasoft.demo.springboot.elasticsearch.springbootelasticsearch.search.annotation.DefinitionQuery;
import com.landasoft.demo.springboot.elasticsearch.springbootelasticsearch.search.annotation.DefinitionQueryRepeatable;
...
public class KeyMapping {
    // 启动类所在包
    private static final String BOOTSTRAP_PATH = SpringBootElasticsearchApplication.class.getPackage().getName();
    /**
     * 字段映射
     * @param clazz Class
     * @return Map
