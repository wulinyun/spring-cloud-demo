package com.landasoft.mas.demo.docker.bean;
...
public class WaterMarkGenerate {
  ...
  //添加文字水印
    /*tarPath:图片保存路径
     *contents:文字水印内容* */
    public static void generateWithTextMark(InputStream inputStream,
...
//      g.drawString(contents, x, y);
        ...
        ImageIO.write(tarBuffImage, "jpg", new FileOutputStream(file));
...
//      g.drawString(contents, x, y);
        ...
        g.dispose();
        ImageIO.write(tarBuffImage, "jpg", new FileOutputStream(tarPath));
        /*JPEGImageEncoder en = JPEGCodec.createJPEGEncoder(new FileOutputStream(tarPath));
        en.encode(tarBuffImage);*/
    }
